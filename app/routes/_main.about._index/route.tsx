...
import { getAboutSummary, getEmploymentInfo, getSocials } from "~/services/personal-info.server"
...
export const loader = async () => {
    ...
    employment.sort((a, b) => {
        if (a.employmentInformation.startDate < b.employmentInformation.startDate) return 1
        else if (a.employmentInformation.startDate > b.employmentInformation.startDate) return -1
        return 0
    })
...
export default function AboutPage() {
    ...
    return (
        <div className="container pt-[10rem]">
            ...
            {
                about.map((v, i) => (
                    <p key={i} className="[&:not(:last-child)]:mb-8">{v}</p>
                ))
            }
