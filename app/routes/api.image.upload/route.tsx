...
export const validateImagePayload = async (request: Request, {
    throwOnError,
    fieldName
}: ValidateImagePayloadParams = {
        throwOnError: true
    }) => {
...
export const handleSingleUpload = async (request: Request, fieldName: string = 'image') => {
